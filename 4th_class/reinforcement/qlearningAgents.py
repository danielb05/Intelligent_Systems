...
# https://github.com/Ani912/UC-Berkeley-Pacman-Project-3/blob/master/analysis.py
...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.values[(state, action)] = (1 - self.alpha) * oldValue + self.alpha * sample
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature in features:
              ...
              self.weights[feature] = oldWeight + self.alpha * features[feature] * difference
